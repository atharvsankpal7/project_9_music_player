    ...
    element.addEventListener("click", () => {
        ...
        switch (index) {
            case 0:
                audioElement = new Audio("mirachi.mp3");
                playbutton.src =
                    "—Pngtree—pause button icon design vector_3728550.png";
                audioElement.play();
                ...
                document.getElementsByClassName("song_item_play")[
                    index
                ].innerHTML = `<img src="/—Pngtree—pause button icon design vector_3728550.png" alt="">`;
                break;
            case 1:
...
playbutton.addEventListener("click", () => {
    if (audioElement.paused || audioElement.currentTime == 0) {
        audioElement.play();
        playbutton.src = "—Pngtree—pause button icon design vector_3728550.png";
        progressbar.value =
